...
class MLHAN_Binary(Module):
    ...
    def forward(self, input_values, level_1_lengths, level_2_lengths):
        ...
        sentence_classification = self.sentence_classification_layer(sentence_representation)
        ...
        return self.sentence_normalizer(sentence_classification), self.paragraph_normalizer(paragraph_classification)
